...
- [ui/console/candidate_pool_ui.py](../ui/console/candidate_pool_ui.py) - ввод criteria для pool.
...
1. Пользователь задает criteria или runtime-фильтр.
...
5. Saved result можно импортировать в общий pool.
...
- `data/candidates/criteria.json` - criteria/defaults для pool.
