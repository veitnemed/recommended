...
| Candidate filters tab | `desktop/candidate_filters_view.py`, `candidates.service` | done |
| Candidate list tab | `desktop/candidate_list_view.py`, `candidates.service` | done |
...
- две вкладки **Фильтры** и **Кандидаты** в [`desktop/app.py`](../desktop/app.py);
- shared state через [`desktop/candidate_search_session.py`](../desktop/candidate_search_session.py);
- runtime-фильтры на вкладке **Фильтры** ([`desktop/candidate_filters_view.py`](../desktop/candidate_filters_view.py));
- лёгкий ranked-список на вкладке **Кандидаты** ([`desktop/candidate_list_view.py`](../desktop/candidate_list_view.py));
