"""Maps candidate-pool canonical fields and raw genre labels to dataset has_* fields."""
...
def normalize_genre_label_to_key(raw_genre: str) -> str | None:
    """Map a raw EN/RU genre label to a canonical pool genre key."""
    return genre_schema.normalize_genre_to_key(raw_genre)
